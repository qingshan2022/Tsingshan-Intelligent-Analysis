import { updateUserInfoUsingPost } from '@/services/xnbi/userController';
...
const UpdateUser: React.FC = () => {
  ...
  const userBirth = moment(currentUser.birth);
       ...
       <Col offset={2} md={12}>
         <Card>
           ...
           >
             ...
             <Form.Item name={'birth'} label={'出生日期'} initialValue={userBirth} >
                <DatePicker showTime />
             </Form.Item>
             <Form.Item wrapperCol={{ ...layout.wrapperCol, offset: 8 }}>
